...
<body>
        ...
        <h1 class=page-title>Culture</h1>
            ...
            <span style="font-weight:bold;">Personnalités liées à la ville</span>
            <br><br><br>
                ...
                <br>
                Agnès Blanbekin, décédée le 10 mars 1315 dans son couvent.
                <br>
                ...
                <h2>Accordion</h2>
                    ...
                    <div class="panel button">
                      ...
                      <br><br>
                      L'apogée de la culture viennoise correspond au début du xxe siècle41 : c'est l'époque de certaines avancées majeures dans le domaine scientifique (invention de la psychanalyse par Sigmund Freud), mais également d'un renouveau important dans le domaine des arts (Sécession viennoise, peinture de Gustav Klimt, d'Oskar Kokoschka et d'Egon Schiele) ou encore dans le domaine de la littérature (œuvres d'Arthur Schnitzler, Joseph Roth, Hermann Broch, Stefan Zweig42 et Robert Musil)43.
                      <br><br>
                    ...
                    <button class="accordion">Musique</button>
                    <div class="panel">
                      <p>
                    ...
                    <button class="accordion">Théâtre et opéra</button>
                    <div class="panel">
                      <p>
